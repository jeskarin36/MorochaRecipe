...
CREATE TABLE IF NOT EXISTS users_preferences (
     ...
     default_services INT DEFAULT 4,
     measurement_unit VARCHAR(20) DEFAULT 'metric', -- Corregido 'matric' a 'metric'
     created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
     updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,     
     UNIQUE(user_id)
);
...
---
-- Creación de Índices para optimizar velocidad
---
...
---
-- Función y Triggers para automatizar el `updated_at`
---
...
CREATE TRIGGER update_users_preferences_updated_at 
    BEFORE UPDATE ON users_preferences FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
CREATE TRIGGER update_shopping_list_items_updated_at 
    BEFORE UPDATE ON shopping_list_items FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();