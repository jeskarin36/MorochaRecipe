            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-8 mb-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                        ...
                        {recipe.difficulty && (
                            <span className={`px-3 py-1.5 rounded-full text-sm font-medium capitalize ${
                                recipe.difficulty === 'easy' || recipe.difficulty === 'fácil' ? 'bg-green-100 text-green-700' :
                                recipe.difficulty === 'medium' || recipe.difficulty === 'media' ? 'bg-yellow-100 text-yellow-700' :
                                'bg-red-100 text-red-700'
                            }`}>
                                {recipe.difficulty === 'easy' ? 'Fácil' : recipe.difficulty === 'medium' ? 'Media' : recipe.difficulty === 'hard' ? 'Difícil' : recipe.difficulty}
                            </span>
                        )}
                    ...
                    <div className="flex flex-wrap gap-6 text-gray-600">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium">Total: {totalTime} minutos</span>
                        </div>
                        {recipe.prep_time && (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {recipe.nutrition && (
                            <div className="bg-white rounded-xl border border-gray-200 p-6">
                                <h2 className="text-xl font-semibold text-gray-900 mb-4">Información Nutricional (por porción)</h2>
                                <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
                                    <NutritionCard label="Calorías" value={recipe.nutrition.calories} unit="kcal" />
                                    <NutritionCard label="Proteínas" value={recipe.nutrition.protein} unit="g" />
                                    <NutritionCard label="Carbohidratos" value={recipe.nutrition.carbs} unit="g" />
                                    <NutritionCard label="Grasas" value={recipe.nutrition.fats} unit="g" />
                                    <NutritionCard label="Fibra" value={recipe.nutrition.fiber} unit="g" />
                                </div>
                            </div>
                        )}
                        ...
                        {recipe.user_notes && (
                            <div className="bg-emerald-50 rounded-xl border border-emerald-200 p-6">
                                <h3 className="font-semibold text-emerald-900 mb-2">📝 Notas</h3>
