...
const DIETARY_OPTIONS = ['Vegetariana', 'Vegana', 'Sin Gluten', 'Sin Lácteos', 'Keto', 'Paleo'];
const COOKING_TIMES = [
    { value: 'quick', label: 'Rápida (<30 min)' },
    { value: 'medium', label: 'Media (30-60 min)' },
...
const RecipeGenerator = () => {
    ...
    const [cuisineType, setCuisineType] = useState('Cualquiera');
        ...
        try {
            ...
            if (preferences) {
                if (preferences.dietary_restrictions && preferences.dietary_restrictions.length > 0) {
                 ...
                 if (preferences.default_serving) {
                    // Nota: Aquí corregí el bug original de tu código cambiando 'setServing' por 'setServings'
                    setServings(preferences.default_serving);
                }
    ...
    const handleGenerate = async () => {
        if (!usePantry && ingredients.length === 0) {
            toast.error('Por favor, añade al menos un ingrediente o usa los elementos de tu despensa');
            return;
        }
       ...
       try {
        const response = await api.post("/recipes/generate", {
            ...
            dietaryRestrictions,
            cuisineType: cuisineType === "Cualquiera" ? "any" : cuisineType,
            servings,
            cookingTime 
        })
        ...
        toast.success("Receta generada con éxito");
          ...
          toast.error(error.response?.data?.message || "Error al generar la receta");
       } finally {
        setGenerating(false);
       }
    };
    ...
    const handleSaveRecipe = async () => {
        ...
        try {
            await api.post("/recipes", {
                ...
                serving: generatedRecipe.serving,
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900">Generador de Recetas con IA</h1>
                    <p className="text-gray-600 mt-2">Deja que la IA cree recetas deliciosas basadas en tus ingredientes</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                            ...
                            <div className="flex gap-2 mb-4">
                                <input
                                    ...
                                    placeholder="Añadir ingrediente (ej. tomates)"
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Restricciones Dietéticas</label>
                                <div className="flex flex-wrap gap-2">
                            ...
                            {/* Tiempo de Cocción */}
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Tiempo de Cocción</label>
                        ...
                        {generatedRecipe ? (
                            <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-6 mt-4 text-sm text-gray-600">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span>{generatedRecipe.servings} porciones</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {generatedRecipe.nutrition && (
                                    <div>
                                        <h3 className="font-semibold text-gray-900 mb-3">Nutrición (por porción)</h3>
                                        <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
                                            <NutritionBadge label="Calorías" value={generatedRecipe.nutrition.calories} unit="kcal" />
                                            <NutritionBadge label="Proteínas" value={generatedRecipe.nutrition.protein} unit="g" />
                                            <NutritionBadge label="Carbohidratos" value={generatedRecipe.nutrition.carbs} unit="g" />
                                            <NutritionBadge label="Grasas" value={generatedRecipe.nutrition.fats} unit="g" />
                                            <NutritionBadge label="Fibra" value={generatedRecipe.nutrition.fiber} unit="g" />
                                        </div>
                                    </div>
                                )}
                                ...
                                {generatedRecipe.cookingTips && generatedRecipe.cookingTips.length > 0 && (
                                    <div className="bg-emerald-50 rounded-lg p-4">
                                        <h3 className="font-semibold text-emerald-900 mb-2">💡 Consejos de Cocina</h3>
                            ...
                            <div className="bg-white rounded-xl border border-gray-200 p-12 text-center h-full flex flex-col items-center justify-center">
                                ...
                                <p className="text-gray-500">Tu receta generada aparecerá aquí</p>
                            </div>
                        )}
                    </div>
                </div>
