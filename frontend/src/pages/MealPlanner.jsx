...
const MealPlanner = () => {
    ...
    const fetchMealPlan = async () => {
        try {
            ...
            const mels = response.data.data.mealPlans;

            // FIX 1: Initialized as an object map instead of an array
            const organized = {};
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            {showAddModal && selectedSlot && (
                <AddMealModal
                    ...
                    onSuccess={() => {
                        // FIX 2: Refetching directly from API guarantees context consistency
                        fetchMealPlan();
                        setShowAddModal(false);
                        setSelectedSlot(null);
                    }}
                ...
                <div className="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p className="text-sm text-gray-600 capitalize">
                            {format(new Date(date.replace(/-/g, '\/')), 'EEEE, MMM d')} - {mealType}
                        </p>
                    </div>
